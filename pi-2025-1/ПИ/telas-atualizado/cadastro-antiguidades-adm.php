<?php 
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        $stmt = $conn->prepare("INSERT INTO produto (NOME, ID_USUARIO, MARCA, QUANT, DIMENSOES, MATERIAL, LANCE_INICIAL, CONDICAO,  DADOS_ADICIONAIS, STATUS_PRODUTO, CATEGORIA) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 1, ?)");

        $stmt->bind_param("sisissdsss", $nome, $id_usuario, $marca, $quantidade, $dimensoes, $materiais, $lance_inicial, $condicao, $informacoes, $categoria);
...
<head>
    ...
    <link rel="stylesheet" href="css/cadastro-antiguidades-adm/-style-cadastro-antiguidades-adm.css">
                ...
                <div class="nav-produtos">
                    <nav>
                        <ul>
                            ...
                            <li style="margin-bottom: -1px;"><a class="selected-nav-produto">Antiguidade</a></li>
                ...
                <div class="divisoria-2">
                    <div class="informacoes-salvar-cancelar">
                        <div class="informacoes">
                            ...
                            <textarea name="informacoes" id="informacoes"><?=$_SESSION['old']['nome'] ?? ''?></textarea>
                        </div>
