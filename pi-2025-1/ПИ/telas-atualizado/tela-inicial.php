...
<body>
    <?php 
        ...
        $stmt = $conn->prepare("SELECT ST_USUARIO, MOTIVO_SUSPENSAO_CONTA FROM usuario WHERE ID = ?");
            ...
            ?>
                <div class="pseudo-body">
                    <div class="suspensao-container">
                        ...
                        <p><?=htmlspecialchars($motivo_suspensao_conta)?></p>
                        <div class="log-msg">
            ...
            <div class="cards-section-1" style="flex-wrap: wrap; gap: 10px;">
                ...
                <?php 
                    ...
                    if (!empty($categoria) && !empty($produto)) {
                        ...
                        $stmt->bind_param("ss", $categoria, $produto);
                        $status = 1;
