        ...
        <section class="main-content">
            <form action="<?=$_SERVER['PHP_SELF']?>" method="POST" enctype="multipart/form-data" class="cadastro-produtos formulario-cadastros form-cadastros">
                ...
                <div class="nav-produtos">
                    <nav>
                        <ul>
                            <li><a href="cadastro-produtos-eletronicos.php" class="not-really-selected">Eletrônico</a></li>
                ...
                <div class="divisoria-1">
                        ...
                        <div class="mqml">
                            <div class="marca-quantidade">
                                ...
                                <div class="quantidade">
                                    ...
                                    <input type="number" name="ano-fabricacao" id="ano-fabricacao" value="<?=$_SESSION['old']['ano-fabricacao'] ?? ''?>" required max="<?=date("Y")?>" min="0">
                                </div>
                                <div class="quantidade">
                    ...
                    <div class="condicao-imagem">
                        <div class="condicao">
                            ...
                            <input type="text" name="condicao-placa" id="condicao" value="<?=$_SESSION['old']['condicao-placa'] ?? ''?>" required>
                        </div>
