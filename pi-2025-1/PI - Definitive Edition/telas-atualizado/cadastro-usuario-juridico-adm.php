                    ...
                    <form style="background-color: #8a3e2c;" action="<?=$_SERVER['PHP_SELF']?>" method="POST" enctype="multipart/form-data" class="form-cadastros" id="form-cadastros">
                        ...
                        <div class="div1">
                            ...
                            <label style="height: 135px;" for="foto" class="imagem-perfil cpf-img" style="cursor: pointer;">
                                <img style="height: 150px;" id="preview" src="imagens/Greek_uc_pi.svg" alt="Imagem de Perfil">
                                <p style="text-align: center; font-weight: bold; margin-top: -20px;">Clique para alterar a imagem</p>
