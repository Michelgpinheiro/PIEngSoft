<?php 
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        if (
            (!isset($_FILES['foto1']) || $_FILES['foto1']['error'] !== UPLOAD_ERR_OK) &&
            (!isset($_FILES['foto2']) || $_FILES['foto2']['error'] !== UPLOAD_ERR_OK) &&
            (!isset($_FILES['foto3']) || $_FILES['foto3']['error'] !== UPLOAD_ERR_OK) &&
            (!isset($_FILES['foto4']) || $_FILES['foto4']['error'] !== UPLOAD_ERR_OK)
        ) {
        ...
        if ($data_inicio->format('Y-m-d') >= $data_fim->format('Y-m-d')) {
            $_SESSION['ini-fim-invalidas'] = "<p><i class='material-icons'>warning</i> A data e horário final do leilão deve ser posterior à inicial</p>";
        ...
        if ($data_inicio->format('Y-m-d') < $data_atual->format('Y-m-d')) {
            $_SESSION['inicio-invalido'] = "<p><i class='material-icons'>warning</i> A data inicial não pode ser anterior à data atual</p>";
        ...
        <section class="main-content">
            ...
            <form action="<?=$_SERVER['PHP_SELF']?>?id=<?=$id_produto?>" method="POST" class="iniciando-leilao cadastro-produtos formulario-cadastros form-cadastros" style="padding-right: 57px;"  enctype="multipart/form-data">
                ...
                <?php
                    ...
                    if (isset($_SESSION['inicio-invalido'])) {
                        ?>
                        <div class="mensagem-sem-foto" id="mensagem-sem-foto" style="margin-top: 20px;">
                            <?=$_SESSION['inicio-invalido']?>
                        </div>
                            <script>
                                // Oculta a mensagem após 4 segundos
                                setTimeout(function() {
                        ...
                        <?php
                        unset($_SESSION['inicio-invalido']);
                    }
                ...
                <div class="main-div-1">
                        ...
                        <div class="img-prv">
                            ...
                            <div class="pracas-reducao-valorincremento">
                                ...
                                <div class="reducao">
                                    ...
                                    <input type="number" name="reducao" id="reducao" value="<?=$_SESSION['old']['reducao'] ?? ''?>" min="0" max="40">
                                </div>
                    ...
                    <div class="data-horario-inicio-final-diferenca">
                        ...
                        <div class="diferenca-dias">
                            ...
                            <input type="number" name="diferenca-dias" id="diferenca-dias" value="<?=$_SESSION['old']['diferenca-dias'] ?? ''?>">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="observacoes-contato">
                        <div class="observacoes">
                            ...
                            <textarea name="observacoes" id="observacoes">
                                <?=$_SESSION['old']['observacoes'] ?? ''?></textarea>
                        </div>
                        <div class="contato">
