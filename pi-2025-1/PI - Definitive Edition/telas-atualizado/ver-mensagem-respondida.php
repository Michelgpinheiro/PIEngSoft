        ...
        <section class="main-content">
            <form style="margin-top: 20px;" action="<?=$_SERVER['PHP_SELF']?>" method="POST" class="entre-em-contato">
                ...
                <div class="descricao-mensagem-enviar">
                    ...
                    <p style="font-size: 16px; margin-top: 10px; overflow-x: auto; width: 715px;"><span>Sua mensagem: </span><?=$mensagem_m?></p>
                    <p style="font-size: 16px; margin-top: 10px; font-weight: bold;"><span>Mensagem de resposta </span></p>
                    <p style="overflow-x: auto; width: 715px; background-color: #fff0ce; color: black; font-size: 16px; font-weight: bold; padding: 10px; border-radius: 10px; margin-bottom: -20px; margin-top: 5px;"><?=$mensagem?></p>
                    <div class="mensagem">
                        <?php 
