<?php 
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        $stmt = $conn->prepare("INSERT INTO produto (NOME, ID_USUARIO, MARCA, TAMANHO, COR, MATERIAL, LANCE_INICIAL, ESTILO, DADOS_ADICIONAIS, STATUS_PRODUTO, CATEGORIA) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 1, ?)");

        $stmt->bind_param("sissssdsss", $nome, $id_usuario, $marca, $tamanho, $cor, $materiais, $lance_inicial, $estilo, $informacoes, $categoria);
...
<head>
    ...
    <link rel="stylesheet" href="css/cadastro-roupas/-style-cadastro-roupas.css">
                ...
                <div class="nav-produtos">
                    <nav>
                        <ul>
                            ...
                            <li style="margin-bottom: -1px;"><a  class="selected-nav-produto">Roupas</a></li>
                        ...
                        <div class="mqml">
                            ...
                            <div class="modelo-lanceinicial">
                                ...
                                <div class="modelo">
                                    ...
                                    <input type="text" name="estilo" id="estilo" value="<?=$_SESSION['old']['estilo'] ?? ''?>" required>
                                </div>
                            </div>
                        </div>
                    </div>
