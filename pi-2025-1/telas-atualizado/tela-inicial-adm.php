                    ...
                    while ($row = $result->fetch_array()) {
                        ...
                        if ($numero_pracas == 2) {
                            ...
                            <div class="card">
                                ...
                                <div class="dar-lance">
                                    <a href="tela-pagamento-adm.php?id='. $id_produto .'">Dar lance</a>
                                    <button class="view">
