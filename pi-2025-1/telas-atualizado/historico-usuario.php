<?php 
    ...
    if (isset($id_usuario_pai)) {
        $stmt = $conn->prepare("SELECT NOME_FANTASIA FROM usuario WHERE ID = ?");
        ...
        while ($row = $result->fetch_assoc()) {
            $nome_usuario_pai = $row['NOME_FANTASIA'];
        }
    }
    ...
    if ($situacao_usuario == 1) {
        ...
        $situacao_usuario_string = "Inativo";
    }
                    ...
                    <div class="info-gerais-usuario-foto-movimentacoes">
                        <div class="info-gerais-usuario">
                            <div class="nome-cpf-telefone-usuario">
                                <?php if (isset($nome_fantasia_usuario)): ?>
                                <div class="nome">
                        ...
                        <div class="foto-movimentacao-usuario">
                            ...
                            <div class="movimentacao-usuario">
                                ...
                                <div class="rolagem-movimentacoes">
                                    ...
                                    <!-- <div class="movimentacoes">
                                        <h3>Leilão de Produto</h3>
                                        <nav>
                                            <ul>
                                                <li><label>Nome: </label> Caixa de Pandora Lacrada</li>
                                                <li><label>Valor: </label>R$ 1.000.000,00</li>
                                            </ul>
                                        </nav>
                                    </div>
                                    <div class="movimentacoes">
                                        <h3>Produto Arrematado</h3>
                                        <nav>
                                            <ul>
                                                <li><label>Nome: </label> Caixa de Pandora Lacrada</li>
                                                <li><label>Valor: </label>R$ 750.000,00</li>
                                            </ul>
                                        </nav>
                                    </div> -->
