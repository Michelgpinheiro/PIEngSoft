<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        if ($senha !== $confirmarSenha) {
            ...
            $stmt = $conn->prepare("INSERT INTO usuario (ID_TP_USU, RAZAO_SOCIAL, NOME_FANTASIA, CNPJ, FONE, LOGRADOURO, BAIRRO, NUMERO, UF, CIDADE, EMAIL, SENHA, PERGUNTA_1, PERGUNTA_2, PERGUNTA_3, ST_USUARIO) VALUES (2, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 1)");
