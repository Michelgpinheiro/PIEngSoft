...
<head>
    ...
    <link rel="stylesheet" href="css/cadastro-produtos-eletronicos/--style-cadastro-produtos-eletronicos.css">
            ...
            <form action="<?=$_SERVER['PHP_SELF']?>" method="POST" enctype="multipart/form-data" class="cadastro-produtos formulario-cadastros form-cadastros">
                ...
                <div class="nav-produtos">
                    <nav>
                        <ul>
                            ...
                            <li><a href="cadastro-veiculos.php" class="not-selected">Veículos</a></li>
                            <li><a href="cadastro-antiguidades.php" class="not-selected">Antiguidade</a></li>
                            <li><a href="cadastro-roupas.php" class="not-selected">Roupas</a></li>
                            <li><a href="cadastro-movel.php" class="not-selected">Móvel</a></li>
                            <li><a href="cadastro-outros.php" class="not-selected">Outros</a></li>
                        </ul>
                    </nav>
                ...
                <div class="divisoria-1">
                    ...
                    <div class="condicao-imagem">
                        ...
                        <label for="foto" class="imagem" style="cursor: pointer;">
