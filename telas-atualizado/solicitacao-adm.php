...
<body>
    ...
    <main>
        ...
        <section class="main-content" style="position: relative; bottom: 54px;">
            <a href="tela-solicitacao-adm.php" class="voltar" style="position: relative; left: 130px; top: 84px;">
