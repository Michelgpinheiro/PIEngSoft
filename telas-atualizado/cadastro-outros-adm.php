...
<head>
    ...
    <link rel="stylesheet" href="css/cadastro-movel-adm/style-cadastro-movel-adm.css">
</head>
<body>
    <header>
            ...
            <div class="cadastro-produtos">
                ...
                <div class="nav-produtos">
                    <nav>
                        <ul>
                            ...
                            <li><a href="cadastro-roupas-adm.php">Roupas</a></li>
                            <li><a href="cadastro-movel-adm.php">Móvel</a></li>
                            <li style="margin-bottom: -1px;"><a class="selected-nav-produto" style="border-bottom: 1px solid lightgray;" >Outros</a></li>
                        </ul>
                    </nav>
                ...
                <div class="divisoria-1">
                    ...
                    <div class="condicao-imagem">
                        ...
                        <div class="imagem">
                            <figure>
                                <img name="imagem" src="https://lojabagaggio.vtexassets.com/arquivos/ids/2339779/0160596440001---Garrafa-Termica-500ml-Em-Aco-Escovado-Prata--1-.jpg?v=638441259286830000" alt="">
