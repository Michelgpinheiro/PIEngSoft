        ...
        <section class="main-content">
            <div class="cadastro-produtos">
                ...
                <div class="nav-produtos">
                    <nav>
                        <ul>
                            <li style="margin-bottom: -1px;"><a class="selected-nav-produto" style="border-bottom: 1px solid lightgray;">Eletrônico</a></li>
                            <li><a href="cadastro-veiculos.php">Veículos</a></li>
                            <li><a href="cadastro-antiguidades.php">Antiguidade</a></li>
                ...
                <div class="divisoria-1">
                    ...
                    <div class="condicao-imagem">
                        ...
                        <div class="imagem">
                            <figure>
                                <img name="imagem" src="https://a-static.mlcdn.com.br/800x560/pc-gamer-completo-amd-ryzen-3-4100-8gb-gt-730-4gb-hd-500gb/olistplus/opm4d8jjzw7j6w3g/f8698572d447a55e8d2564fc52701cfb.jpeg" alt="">
